...
list: is an array of player of the form "Name: score", 
sorted by score in descending order (in alphabetic order of name in case of same score).
  eg : ["Alya: 325", "Boris: 253", "Clem: 235"]

list.length is limited to size items. 
...
Examples:
  let top3 = new HallOfFame(3, [["Ada",99], ["Bob","42], ["Clo", 101], ["Dan", 3]])
  ...
  let top5 = new HallOfFame(); // -- size=5 by default
